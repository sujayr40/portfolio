...
const typed = new Typed('.multiple-text', {
    strings: ['Frontend Developer', 'Digital Marketer', 'Digital Product Seller',],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
...
function sendEmail() {
    ...
    Email.send({
        SecureToken : "157a3fd6-c386-429f-aef2-4e2d6e0152cc",
        To : 'sujayr40@gmail.com',
        From : "sujayr40@gmail.com",
